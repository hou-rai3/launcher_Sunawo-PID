...
uint8_t *motor_control(int16_t target, int16_t speed_now, PID &pid_controller, CAN &can, CANMessage &msg, uint8_t *DATA, int DJI_ID, bool &flag)
{
    // for (int id = 0x201; id < 0x205; ++id)
    // {
    //     if (can.read(msg) == id)
    //     {
    //         if (id == 0x201)
    ...
    //         else if (id == 0x202)
    //         {
    //             speed_now = (msg.data[2] << 8) | msg.data[3];
    //         }
    //         else if (id == 0x203)
    //         {
    //             speed_now = (msg.data[4] << 8) | msg.data[5];
    //         }
    //         else if (id == 0x204)
    //         {
    //             speed_now = (msg.data[6] << 8) | msg.data[7];
    //         }
    //     }
    // }
    // if (can.read(msg) == 0x201)
    // {
    //     speed_now = (msg.data[2] << 8) | msg.data[3];
    //     printf("speed_now=:%d\n", speed_now);
    // }
